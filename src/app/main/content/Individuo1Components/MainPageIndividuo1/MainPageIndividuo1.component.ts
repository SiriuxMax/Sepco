...
@Component({
    selector: 'MainPageIndividuo1',
    templateUrl: './MainPageIndividuo1.component.html',
    styleUrls: ['./MainPageIndividuo1.component.scss']
})
export class MainPageIndividuo1Component implements OnInit {
