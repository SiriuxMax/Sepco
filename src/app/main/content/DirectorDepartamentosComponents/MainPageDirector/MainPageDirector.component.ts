...
@Component({
    selector: 'MainPageDirector',
    templateUrl: './MainPageDirector.component.html',
    styleUrls: ['./MainPageDirector.component.scss']
})
export class MainPageDirectorComponent implements OnInit {
