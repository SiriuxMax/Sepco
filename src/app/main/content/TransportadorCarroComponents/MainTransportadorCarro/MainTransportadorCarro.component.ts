...
@Component({
    selector: 'MainTransportadorCarro',
    templateUrl: './MainTransportadorCarro.component.html',
    styleUrls: ['./MainTransportadorCarro.component.scss']
})
export class MainTransportadorCarroComponent implements OnInit {
