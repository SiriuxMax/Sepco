...
export class ListarDirectoresComponent implements OnInit {
    ...
    ObtenerReuniones() {
        ...
        this.ImageService.ListarAllDirectorDepto().subscribe((x) => {
            debugger;
            x.forEach(element => {
    ...
    nuevo(){
        this.Router.navigate(['/directordepartamento'])
    }
}
