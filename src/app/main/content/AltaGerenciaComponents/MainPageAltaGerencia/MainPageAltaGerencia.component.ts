...
@Component({
    selector: 'MainPageAltaGerencia',
    templateUrl: './MainPageAltaGerencia.component.html',
    styleUrls: ['./MainPageAltaGerencia.component.scss']
})
export class MainPageAltaGerenciaComponent implements OnInit {
